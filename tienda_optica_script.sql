...
-- -----------------------------------------------------
-- Table `S201exercici1`.`Marcas`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `S201exercici1`.`Marcas` (
  `idMarcas` INT NOT NULL AUTO_INCREMENT,
  `Marca` VARCHAR(45) NOT NULL,
  `Provedor_Provedor_id` INT NOT NULL,
  PRIMARY KEY (`idMarcas`, `Provedor_Provedor_id`),
  UNIQUE INDEX `idMarcas_UNIQUE` (`idMarcas` ASC) VISIBLE,
  UNIQUE INDEX `Marca_UNIQUE` (`Marca` ASC) VISIBLE,
  INDEX `fk_Marcas_Provedor1_idx` (`Provedor_Provedor_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `S201exercici1`.`Gafas` (
  ...
  PRIMARY KEY (`Gafas_id`, `Marcas_idMarcas`),
  INDEX `fk_Gafas_Marcas1_idx` (`Marcas_idMarcas` ASC) VISIBLE,
  CONSTRAINT `fk_Gafas_Marcas1`
    FOREIGN KEY (`Marcas_idMarcas`)
    REFERENCES `S201exercici1`.`Marcas` (`idMarcas`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `S201exercici1`.`Gafas_has_Venta` (
  ...
  CONSTRAINT `fk_Gafas_has_Venta_Gafas1`
    ...
    REFERENCES `S201exercici1`.`Gafas` (`Gafas_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
